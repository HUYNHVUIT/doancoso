...
public class HomeController {
    ...
    @GetMapping("/dat-hang")
    public String getCartPage(Model model, @RequestParam String id, @RequestParam int size, HttpServletRequest request){
...
//        UserDTO user = (UserDTO) request.getSession().getAttribute("user");
        ...
        sendOrderConfirmationEmail(user.getEmail(), product, size);

        return "shop/payment";
    }
    public void sendOrderConfirmationEmail(String email, DetailProductInfoDTO product, int size) {
        String subject = "Đặt hàng thành công";
        String text = "Xin chào,\n\nBạn đã đặt hàng thành công với thông tin sau:\n\n"
                + "Sản phẩm: " + product.getName() + "\n"
                + "Kích cỡ: " + size + "\n"
                + "Xin cảm ơn!";
        senMail(email, subject, text);
    }
    public void senMail( String to, String subject, String text){
